...
public class StockInteractor_Get_by_Code_Test : BaseTest
{
  ...
  public StockInteractor_Get_by_Code_Test(ITestOutputHelper output) : base(nameof(StockInteractor_Get_by_Code_Test), output)
  {
  ...
  public async void WHEN_get_THEN_get_all()
  {
    ...
    // Act
    var asserted_stock = await stockInteractor.Get(expected_stock.Code);
